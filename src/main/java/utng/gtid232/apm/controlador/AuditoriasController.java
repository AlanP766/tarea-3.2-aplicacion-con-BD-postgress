...
import utng.gtid232.apm.dao.AuditorDAO;
import utng.gtid232.apm.dao.EmpresaDAO;
import utng.gtid232.apm.modelo.Auditoria;
import utng.gtid232.apm.modelo.Auditor;
import utng.gtid232.apm.modelo.Empresa;
...
public class AuditoriasController {
    ...
    public void crearAuditoria() {
        ...
        try {
            Auditoria a = new Auditoria(
                cmbEmpresa.getValue().getIdEmpresa(),
                cmbAuditor.getValue().getIdAuditor(), 
    ...
    public void cancelarAuditoria() {
        ...
        try {
            // CORREGIDO: Enviar LocalDate.now() para registrar la fecha en que se canceló
            auditoriaDAO.actualizarEstatus(seleccionada.getIdAuditoria(), "Cancelada", LocalDate.now());
            cargarAuditorias();
        } catch (SQLException e) {
